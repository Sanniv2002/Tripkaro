...
export function ExpenseList({ user, expenses, setTrip, participants, tripId, setRefreshTrip }: any) {
  ...
  async function handleDeleteExpense(id: string) {
    ...
    try {
      ...
      toast({
        ...
        description: "You cannot delete an expense created by another participant.",
      })
    } finally {
      setProcessing(false);
      setOpenDialog(false);
            ...
            {expenses.map((expense: any) => (
              ...
              >
                ...
                <div className="flex items-center space-x-4 w-full sm:w-auto justify-between sm:justify-end">
                  ...
                  <AlertDialog open={deletingExpenseId === expense.id} onOpenChange={(open) => {
                    if (!open) setDeletingExpenseId(null);  // Reset the id when dialog is closed
                  }}>
                    <AlertDialogTrigger>
                      <Trash2 className="h-4 w-4" onClick={() => setDeletingExpenseId(expense.id)} />
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => deletingExpenseId && handleDeleteExpense(deletingExpenseId)}>
                          {processing ? (
